...
export default function TravelGuidanceScreen() {
  ...
  const [travelGuidance, setTravelGuidance] = useState<TravelGuidance[]>([]);
  ...
  const handleItemPress = (item: TravelGuidance) => {
    router.push({
  ...
  const renderCategorySection = (title: string, items: TravelGuidance[], icon: string, color: string) => {
