...
export default function ContentDetailScreen() {
  ...
  const tipsArray = tips ? (tips as string).split('|') : [];
  const tagsArray = tags ? (tags as string).split(', ') : [];
  const relatedFactsArray = relatedFacts ? (relatedFacts as string).split(',') : [];
          ...
          <ThemedView style={[styles.header, { backgroundColor: colors.cardHeader }]}>
            ...
            <ThemedView style={[styles.headerContent, { backgroundColor: colors.cardHeader }]}>
              <ThemedView style={[styles.titleContainer, { backgroundColor: colors.cardHeader }]}>
                <IconSymbol
                  name={getTypeIcon(type as string) as any}
                  size={24}
            ...
            <ThemedView style={[styles.contentContainer, { backgroundColor: colors.background }]}>
              ...
              {type === 'emergency' && phoneNumber && (
                <TouchableOpacity
                  ...
                  onPress={() => handleCall(phoneNumber as string)}
                >
              ...
              <ThemedView style={[styles.infoCard, { backgroundColor: colors.card }]}>
                ...
                {priority && (
                  <ThemedView style={[styles.infoRow, { backgroundColor: colors.card }]}>
                    ...
                    <ThemedView style={[styles.priorityBadge, { backgroundColor: getPriorityColor(priority as string) }]}>
                ...
                {severity && (
                  <ThemedView style={[styles.infoRow, { backgroundColor: colors.card }]}>
                    ...
                    <ThemedView style={[styles.severityBadge, { backgroundColor: getSeverityColor(severity as string) }]}>
                ...
                {difficulty && (
                  <ThemedView style={[styles.infoRow, { backgroundColor: colors.card }]}>
                    ...
                    <ThemedView style={[styles.difficultyBadge, { backgroundColor: getDifficultyColor(difficulty as string) }]}>
                ...
                {importance && (
                  <ThemedView style={[styles.infoRow, { backgroundColor: colors.card }]}>
                    ...
                    <ThemedView style={[styles.importanceBadge, { backgroundColor: getImportanceColor(importance as string) }]}>
                ...
                {lastUpdated && (
                  <ThemedView style={[styles.infoRow, { backgroundColor: colors.card }]}>
                    ...
                    <ThemedText style={[styles.infoValue, { color: colors.text }]}>
                      {new Date(lastUpdated as string).toLocaleDateString()}
                    </ThemedText>
                  </ThemedView>
                )}
              </ThemedView>
